          ...
          <AnimateOnScroll animation="slide-right">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button variant="goldOutline" size="xl" asChild>
                <a href="tel:017672405079">Jetzt anrufen</a>
              </Button>
            </div>
          </AnimateOnScroll>
          ...
          <AnimateOnScroll animation="slide-left">
            <div className="relative">
              <div className="aspect-square lg:aspect-[4/5] rounded-sm overflow-hidden border border-border">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2593.888981704378!2d11.075002076892412!3d49.448815258975166!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x479f57f7bb38ac9d%3A0x224149c8902832a6!2sMahawi&#39;s%20Barbershop!5e0!3m2!1sde!2sde!4v1769197620619!5m2!1sde!2sde"
                  width="100%"
                  height="100%"
                  ...
                  title="Standort Mahawi’s Barbershop Nürnberg"
                />
              </div>
